...
def _get_input_embeds(
    ...
    if pixel_values is not None:
        ...
        if n_image_tokens != n_image_features:
            ...
            print(msg)
            _log_path = os.environ.get("BAD_SAMPLES_LOG", "/mnt/dolphinfs/ssd_pool/docker/user/hadoop-hldy-nlp/3A/multimodal/fengkaituo/Qwen3-train/EasyR1/bad_samples.txt")
            try:
